...
class TemplateNameParserTest extends TestCase
{
    ...
    public function parseProvider()
    {
        return array(
            ...
            array('FooBundle:Post:blog.html.twig', 'FooBundle:Post:blog.html.twig', '@FooBundle/Resources/views/Post/blog.html.twig', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'twig')),
